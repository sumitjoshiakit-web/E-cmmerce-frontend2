...
export function Home() {
  ...
  useEffect(() => {
    fetchAllProducts()
      .then((data) => {
        // Pick top 4 rated products for the spotlight
      ...
      <section className="relative overflow-hidden rounded-3xl bg-gray-900 text-white px-6 py-16 sm:px-12 sm:py-20 lg:px-16 shadow-lg">
        ...
        <div className="relative max-w-3xl space-y-6">
          <div className="inline-flex items-center gap-2 rounded-full bg-white/10 backdrop-blur-md px-3.5 py-1.5 text-xs font-semibold text-amber-300 border border-white/10">
            ...
            <span>Enhanced with Client-Side AI Assistant</span>
          </div>
          ...
          <p className="text-base sm:text-lg text-gray-300 max-w-2xl leading-relaxed">
            Explore quality essentials powered by intelligent cart insights, real-time AI buying advice, and instant checkout.
          </p>
      ...
      <section className="grid grid-cols-2 md:grid-cols-4 gap-4">
        <div className="bg-white rounded-2xl border border-gray-200 p-5 shadow-2xs flex items-start gap-3.5">
          ...
          <div>
            ...
            <p className="text-xs text-gray-500 mt-0.5">Complimentary on orders $50+</p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl border border-gray-200 p-5 shadow-2xs flex items-start gap-3.5">
          ...
          <div>
            <h4 className="font-bold text-sm text-gray-900">AI Concierge</h4>
            <p className="text-xs text-gray-500 mt-0.5">Live cart & deal suggestions</p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl border border-gray-200 p-5 shadow-2xs flex items-start gap-3.5">
          ...
          <div>
            <h4 className="font-bold text-sm text-gray-900">Verified Quality</h4>
            <p className="text-xs text-gray-500 mt-0.5">Authentic catalog items</p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl border border-gray-200 p-5 shadow-2xs flex items-start gap-3.5">
          ...
          <div>
            ...
            <p className="text-xs text-gray-500 mt-0.5">Risk-free satisfaction guarantee</p>
          </div>
        </div>
      </section>
      ...
      <section className="space-y-6">
        <div className="flex items-end justify-between gap-4">
          <div>
            ...
            <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 tracking-tight mt-0.5">
              Customer Favorites
            </h2>
          </div>
          <Link
            to="/shop"
            className="text-sm font-semibold text-gray-900 hover:text-gray-600 inline-flex items-center gap-1 transition"
          >
            <span>View All</span>
            <ArrowRight className="w-4 h-4" />
          </Link>
